...
export const FormInput = (fieldRenderProps) => {
    const { validationMessage, touched, label, id, ref,valid, disabled, hint, type, optional, ...others } = fieldRenderProps;
...
export const FormPasswordInput = (fieldRenderProps) => {
    const { validationMessage, touched, label, id,ref, valid, disabled, hint, type, optional,password, ...others } = fieldRenderProps;
...
export const FormMaskedTextBox = (fieldRenderProps) => {
    const { validationMessage, touched, label, id,ref, valid, hint, optional, ...others } = fieldRenderProps;
...
export const FormDropDownList = (fieldRenderProps) => {
    const { validationMessage, touched, label, id,ref, valid, disabled, hint, wrapperStyle, ...others } = fieldRenderProps;
    const editorRef = React.useRef(null);
